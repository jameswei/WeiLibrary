...
tools.get_id = function(db){//生成mongodb _id
	var seed=(new Date().getTime()*2+''+new Date().getTime()).slice(0,24);
	return db.bson_serializer.ObjectID.createFromHexString(seed).toString();
}
